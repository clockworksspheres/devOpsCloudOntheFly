...
Packer will try to install this from the local website indicated by "iso_url_1".

if the website is not functioning, packer will look for a local iso.
...
If no iso's are found, packer will grab the iso from the web. 
